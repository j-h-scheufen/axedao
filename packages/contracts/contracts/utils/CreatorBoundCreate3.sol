...
/**
  ...
  Based on https://github.com/0xSequence/create3/blob/master/contracts/Create3.sol
*/
library CreatorBoundCreate3 {
  ...
  */
  function addressOf(bytes32 _salt) internal view returns (address) {
    address proxy = address(
      uint160(
        uint256(
          keccak256(abi.encodePacked(hex"ff", address(this), _salt, KECCAK256_PROXY_CHILD_BYTECODE))
        )
      )
    );
