...
**SQL Import:** `docs/genealogy/sql-imports/entities/persons/ambrosio.sql`

**Significance / Significância:**
- EN: Pre-Pastinha era capoeira angola practitioner who participated in the historic 1937 II Congresso Afro-Brasileiro demonstration
- PT: Praticante de capoeira angola da era pré-Pastinha que participou da histórica demonstração do II Congresso Afro-Brasileiro de 1937
...
| Apelido | Ambrósio |
| Born / Nascimento | c. 1890 (estimated / estimado), Salvador, Bahia |
| Died / Falecimento | Unknown / Desconhecido |
| Location / Local | Salvador, Bahia, Brazil |
| Title / Título | None (pre-formal title era / era pré-título formal) |
| Style / Estilo | Angola |
...
- Listed among established practitioners in historical documentation
...
- Listado entre os praticantes estabelecidos na documentação histórica

## Style Notes / Notas de Estilo

### English

Pre-modern era capoeira Angola practitioner from Salvador. Active in the 1930s alongside the generation that included Querido de Deus, Barbosa, Onça Preta, Zeppelin, and Juvenal. His participation in the 1937 II Congresso Afro-Brasileiro demonstration indicates he was recognized among the established practitioners of the era. No specific details about his individual playing style have been documented.

### Português

Praticante de capoeira Angola da era pré-moderna de Salvador. Ativo na década de 1930 ao lado da geração que incluía Querido de Deus, Barbosa, Onça Preta, Zeppelin e Juvenal. Sua participação na demonstração do II Congresso Afro-Brasileiro de 1937 indica que era reconhecido entre os praticantes estabelecidos da época. Nenhum detalhe específico sobre seu estilo individual de jogo foi documentado.
...
### 1937 II Congresso Afro-Brasileiro Contemporaries / Contemporâneos do II Congresso Afro-Brasileiro de 1937

Participants in the historic January 14, 1937 demonstration at Club de Regatas Itapagipe.

**Note:** Event co-attendance is documented here for reference but NOT modeled as `associated_with` statements (which would create N*(N-1)/2 redundant relationships). The `associated_with` predicate is reserved for meaningful personal connections beyond mere event co-attendance.

| Name / Nome | In Dataset? | Notes / Notas |
|-------------|-------------|---------------|
| Samuel Querido de Deus | Yes / Sim | Director of the exhibition / Diretor da exibição |
| Barbosa | Yes / Sim | Also informant for Carneiro / Também informante de Carneiro |
| Onça Preta | Yes / Sim | |
| Juvenal (Engraxate) | Yes / Sim | |
| Zeppelin | Yes / Sim | Also informant for Carneiro / Também informante de Carneiro |
| Bugaia | Pending | In backlog / No backlog |
| Fernandes | Pending | In backlog / No backlog |
| Eutíquio | Pending | May be same as Gato Preto's father / Pode ser mesmo que pai de Gato Preto |
| Neném (1937 Congress) | Pending | In backlog; distinct from Neném Itabuna / No backlog; distinto de Neném Itabuna |
| Zei | Pending | In backlog / No backlog |
| Barroso | Pending | In backlog / No backlog |
| Arthur Mattos | Pending | In backlog / No backlog |
| Raphael | Pending | In backlog / No backlog |
| Edgar (1937 Congress) | Pending | In backlog / No backlog |
| Damião | Pending | In backlog; may need disambiguation / No backlog; pode precisar de desambiguação |

## Date Discrepancies / Discrepâncias de Datas

| Field | Primary | Alternative | Notes |
|-------|---------|-------------|-------|
| Birth year | c. 1890 | - | Estimated based on active participation in 1937 demonstration; no documented birth date |
...
- [Velhos Mestres - O ABC de Grandes Mestres de Capoeira](https://velhosmestres.com/br/destaques-38)
- [Mapa da Capoeira - Centro Esportivo de Capoeira Angola de Mestre Pastinha](https://www.mapadacapoeira.com.br/descricaopontos.aspx?fk_ponto=14)
- Estado da Bahia newspaper (January 13-14, 1937) - contemporary account
- Edison Carneiro, "Negros Bantus" (1937) - documentation of II Congresso Afro-Brasileiro
