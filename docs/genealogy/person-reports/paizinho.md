# Mestre Paizinho / Teodoro Ramos (~1890 - 1945)

**SQL Import:** `docs/genealogy/sql-imports/entities/persons/paizinho.sql`

**Significance / Significância:**
- EN: Second-generation disciple from African diaspora; teacher of Mestre Artur Emídio (1937-1945); ran academy in Itabuna during prohibition era; crucial link connecting African-born Mestre Neném to one of the four founding lineages of contemporary Rio de Janeiro capoeira.
- PT: Discípulo de segunda geração da diáspora africana; professor de Mestre Artur Emídio (1937-1945); dirigia academia em Itabuna durante era de proibição; elo crucial conectando Mestre Neném nascido na África a uma das quatro linhagens fundadoras da capoeira contemporânea do Rio de Janeiro.
...
|---------------|---------------|
| Full Name / Nome Completo | Teodoro Ramos |
| Apelido | Paizinho ("Little Father" / "Papaizinho") |
| Born / Nascimento | ~1890 (decade precision / precisão de década) |
| Died / Falecimento | 1945 (year precision / precisão de ano) |
| Birth Location / Local de Nascimento | Unknown (likely southern Bahia / provavelmente sul da Bahia) |
| Death Location / Local de Falecimento | Itabuna, Bahia |
| Title / Título | None documented (pre-formal title era / era pré-títulos formais) |
...
|------|--------------|--------|-------|
| Neném (Itabuna) | Primary mestre | Late 1800s/early 1900s | African-born; Layer Zero figure; taught in Itabuna; in dataset (nenem-itabuna.sql) |

## Students / Alunos

| Name | Period | Notes |
|------|--------|-------|
| Artur Emídio de Oliveira | 1937-1945 | Began training age 7; took over Paizinho's academy after his death; one of four founding lineages of Rio contemporary capoeira; in dataset (artur-emidio.sql) |

## Lineage / Linhagem

```
Neném (African, ~1860-?)
    └── Paizinho (Teodoro Ramos, ~1890-1945)
...
|---------------|-------------------|---------------------------|---------------|
| Birth year | ~1890 | Could be 1897-1907 | Estimated; if 30-40 when teaching from 1937 |
| Death year | 1945 | 1946 (velhosmestres.com) | Majority of sources say 1945 |

## Death Circumstances / Circunstâncias da Morte

**Primary account (Artur Emídio):** Died of meningitis—"morte morrida" (natural death).

**Legend:** On moonlit nights in Itabuna and Ilhéus, Paizinho attempted to fly from the top of a coconut tree using palm leaves as wings, like Icarus in Greek mythology, and fell to his death.

**Assessment:** Artur Emídio explicitly rejected the Icarus legend. The legend appears to be local folklore mythologizing a mysterious teacher figure. Using meningitis as documented cause of death.

## Training Conditions / Condições de Treinamento

| Aspect | Detail |
|--------|--------|
| Location | Itabuna, Bahia (cocoa belt region) |
| Training sites | "Hilltops, alleyways, at night, always hidden"; "in the street, on the pavement" |
| Time | 6 AM daily (before authorities active) |
| Academy | Formal academy in Itabuna |
| Arrests | Multiple; pattern: arrested → bail paid next day → resumed teaching same evening |

**Key quote (Artur Emídio):**
> "The practice of Capoeira was prohibited. They trained on top of hills, in alleyways, at night and always hidden. Many were the times that my Master was arrested. But the next day the bail was paid, and he would leave. And at night, he would return to teach Capoeira, practiced for love!"
...
- If he was 30-40 when teaching started (1937), born ~1897-1907
- Using 1890 as midpoint estimate with decade precision

### The Icarus Legend
The legend of Paizinho attempting to fly from a coconut tree like Icarus is a curious piece of local folklore. It may reflect:
1. Community mythologizing of a mysterious, perhaps eccentric figure
2. Metaphorical interpretation of his "transcendent" teaching
3. Confusion with another local figure
4. Simple folk embellishment over generations

Artur Emídio's explicit rejection of this legend in favor of meningitis suggests the legend developed after his death and was not part of the original community memory.

## Sources / Fontes

### Primary Sources
- [Velhos Mestres: Artur Emídio (English)](https://velhosmestres.com/en/featured-69) - Primary documentation; contains Artur Emídio's testimony about Paizinho
- [Velhos Mestres: Artur Emídio (Portuguese)](http://velhosmestres.com/br/destaques-69) - Contains death legend details
- [Contemporary Capoeira: Master Artur Emídio](https://capoeirahistory.com/mestre/master-artur-emidio-1930-2011/) - Biography with Paizinho context

### Secondary Sources
- [Nossa Tribo: Mestre Artur Emídio](https://nossa-tribo.com/mestre-artur-emidio/) - Lineage and training details
- [Portal Capoeira: Nota de Falecimento Artur Emídio](https://portalcapoeira.com/capoeira/noticias-atualidades/nota-de-falecimento-mestre-artur-emidio/) - Obituary confirming lineage
- [Contemporary Capoeira: Master Paulo Gomes](https://capoeirahistory.com/mestre/master-paulo-gomes/) - Genealogy chain: Neném → Paizinho → Artur Emídio → Paulo Gomes
- [Contemporary Capoeira: From the Ring to the Stage](https://capoeirahistory.com/from-the-ring-to-the-stage-a-movie-about-master-artur-emidio/) - Documentary with lineage references

### Academic Reference
- Machado (1998) - Cited in capoeirahistory.com as source for the genealogy chain

### Related Person Reports
- [Neném (Itabuna)](nenem-itabuna.md) - Teacher; African-born Layer Zero figure
- [Artur Emídio](artur-emidio.md) - Student; one of four founding lineages of contemporary Rio capoeira
- [Leopoldina](leopoldina.md) - Grand-student (via Artur Emídio)
- [Paulo Gomes](paulo-gomes.md) - Grand-student (via Artur Emídio)
