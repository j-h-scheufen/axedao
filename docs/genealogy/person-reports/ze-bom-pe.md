...
**SQL Import:** `docs/genealogy/sql-imports/entities/persons/ze-bom-pe.sql`
...
This profile is based entirely on a single source: Pastinha's 1967 interview with Revista Realidade magazine ("É Luta, É Dança, É Capoeira" by Roberto Freire, photos by David Drew Zingg). No additional documentation about Zé Bom Pé has been found.

### Not Listed in 1976 Source
A 1976 source (velhosmestres.com/br/pastinha-1976) reproduces a similar list of "angoleiros de briga" but substitutes Besouro for Zé Bom Pé and omits some names. The 1967 source is considered primary as it is closer to the original interview.

### No Gengibirra/Liberdade Connection Found
Unlike some other figures on Pastinha's list (e.g., Amorzinho, Doze Homens), Zé Bom Pé is not mentioned in sources about the Gengibirra roda or the 1941 transition to CECA. His relationship to these groups is unknown.
...
- [Velhos Mestres: Pastinha 1967 (EN)](https://velhosmestres.com/en/pastinha-1967) - Reproduction of Pastinha's 1967 interview content
