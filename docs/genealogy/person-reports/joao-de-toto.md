...
**Significance:** Famous capoeira figure of Recife; arrested during police suppression campaigns; his ginga contributed to the development of frevo.

**Profile Type:** `historical_capoeirista`

**SQL Import:** `docs/genealogy/sql-imports/entities/persons/joao-de-toto.sql`

## Basic Information / Informações Básicas

| Field | Value |
|-------|-------|
| Apelido | João de Totó |
...
|---------|-----------|-------|--------------|-------------|---------|-------|
| Valdevino | - | - | arrested together | check | yes | Mentioned alongside João de Totó in police campaigns |

## Date Discrepancies / Discrepâncias de Datas

**Birth year estimated at 1870 with decade precision.** Active as prominent valentão in late 1800s/early 1900s Recife. Arrested during police campaigns in early 1900s alongside Jovino dos Coelhos. If active as adult in 1890s-1900s, likely born 1860-1880. Using 1870 as midpoint estimate.

## Notes / Notas

There is a neighborhood in Recife called "Totó" which is the smallest neighborhood in the city. The connection between João de Totó and this neighborhood name is unclear.
...
- [Wikipedia: Totó (Recife)](https://pt.wikipedia.org/wiki/Tot%C3%B3_(Recife))
