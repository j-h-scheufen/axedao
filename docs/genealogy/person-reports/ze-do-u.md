...
**SQL Import:** `docs/genealogy/sql-imports/entities/persons/ze-do-u.sql`
...
| 1976 | Listed again in O Globo article among "angoleiros de briga" |
...
### Apelido Analysis
"Zé do U" follows Brazilian naming convention: "Zé" (short for José) + "do U" (likely a place, occupation, or characteristic). The "U" could refer to:
- A neighborhood or street (e.g., "Rua do U" or similar)
...
- [Velhos Mestres: Pastinha 1976 (BR)](https://velhosmestres.com/br/pastinha-1976) - 1976 O Globo article with list of "angoleiros de briga"
