# Juvenil (Unknown - Unknown)

**SQL Import:** `docs/genealogy/sql-imports/entities/persons/juvenil.sql`

**Significance / Significância:**
- EN: Anonymous street capoeirista from 1950s Rio de Janeiro; known only from a single anecdote in Mestre Leopoldina's testimony about an encounter on Morro da Favela.
- PT: Capoeirista de rua anônimo do Rio de Janeiro dos anos 1950; conhecido apenas por uma única anedota no depoimento de Mestre Leopoldina sobre um encontro no Morro da Favela.

**Profile Type:** `NULL` (no formal title)
...
### Documented Encounter / Encontro Documentado

- **Mestre Leopoldina** - Sparred with Leopoldina on Morro da Favela (~1951-1952); threw meia-lua that grazed Leopoldina's head, prompting Quinzinho's intervention.
- **Quinzinho** - Present during the encounter; threatened Juvenil with a pistol to protect his student Leopoldina.
...
Juvenil was NOT a student of Quinzinho. He was described as "someone who could also play"—an independent capoeirista they encountered on the street who already knew capoeira techniques.

## Sources / Fontes

- [Master Leopoldina - Part 2 (Capoeira History)](https://capoeirahistory.com/general/master-leopoldina-part-2/)
- Documentary: "Mestre Leopoldina, a Fina Flor da Malandragem" (2005), directed by Rose La Creta
