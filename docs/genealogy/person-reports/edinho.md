...
**SQL Import:** `docs/genealogy/sql-imports/entities/persons/edinho.sql`

**Significance / Significância:**
- EN: One of only four students formally graduated to mestre (white handkerchief) by Mestre Bimba; primary source for identifying all four recipients; deceased before 1974.
- PT: Um dos apenas quatro alunos formalmente graduados a mestre (lenço branco) por Mestre Bimba; fonte primária para identificar todos os quatro destinatários; falecido antes de 1974.
...
| Apelido | Edinho |
| Born / Nascimento | c. 1920s (estimate) / c. anos 1920 (estimativa) |
| Died / Falecimento | Before 1974 / Antes de 1974 |
...
- Primary source for identifying all four white handkerchief recipients
...
- Fonte primária para identificar todos os quatro destinatários do lenço branco
...
### Português
Treinou diretamente com Mestre Bimba e recebeu a maior honra da Capoeira Regional: o lenço branco significando o status de mestre. Um dos apenas quatro alunos a receber esta distinção de Bimba durante sua vida. O próprio Edinho é a fonte da declaração que identifica todos os quatro destinatários.

## Teachers / Mestres

- **Mestre Bimba** (dates unknown - 1974) - Primary and only documented capoeira teacher. Relationship ended with Edinho's death (before Bimba's death in 1974). Received the lenço branco (white handkerchief) directly from Bimba—the highest honor in Capoeira Regional.

## Students / Alunos

No documented students identified.

## Connections / Conexões

Edinho was one of only four students to receive the lenço branco (white handkerchief) directly from Mestre Bimba. The four recipients—Decânio, Jair Moura, Miranda, and Edinho—are all documented via their individual `student_of` and `received_title_from` relationships with Bimba. Their connection as fellow recipients is recorded in each person's bio rather than as separate `associated_with` statements.

## Date Discrepancies / Discrepâncias de Datas

| Field | Primary | Alternative | Notes |
|-------|---------|-------------|-------|
| Birth year | ~1920 (decade estimate) | - | Estimated based on contemporary status with Decânio (1923); no documented date |
| Death | Before 1974 | - | Per Mestre Itapoan: "the other two [white handkerchief recipients] to people who have since died" |
...
### Primary Sources
- [Portal Capoeira - Contramestre e não mestrando](https://portalcapoeira.com/capoeira/publicacoes-e-artigos/contramestre-e-nao-mestrandomestrando-em-capoeira/) - Contains Mestre Edinho's authoritative quote identifying the four white handkerchief recipients
- [Cativeiro.de - Graduation](http://www.cativeiro.de/?page_id=39&lang=en) - Lists the four mestres graduated by Bimba

### Secondary Sources
- [Capoeira Connection - Lecture on Mestre Bimba and Capoeira Regional](https://capoeira-connection.com/capoeira/2011/10/lecture-on-mestre-bimba-and-capoeira-regional/) - Mestre Itapoan's lecture confirming Edinho and Miranda are deceased
...
- Existing genealogy reports: `bimba.sql`, `decanio.sql`, `jair-moura.md`, `miranda.sql`
