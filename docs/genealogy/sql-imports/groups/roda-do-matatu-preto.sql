-- ============================================================
-- GENEALOGY GROUP IMPORT: Roda do Matatu Preto
-- Generated: 2025-12-10
-- Primary Sources:
--   - Mestre Canjiquinha testimony (1989) via velhosmestres.com/br/destaques-2
-- ============================================================
-- DEPENDENCIES: none
-- ============================================================
...
-- It was an informal gathering of capoeiristas in Salvador who met
-- on Sundays to train. We document it as a "proto_group" to capture
-- the social structure of pre-formalization era capoeira.
-- ============================================================
