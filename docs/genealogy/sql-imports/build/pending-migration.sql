...
-- Generated: 2026-01-03T02:28:22.071Z
-- ============================================================
--
-- New entity files: 41
-- Changed entity files: 2
...
-- (from cleanup-aberre-duplicate.sql)
-- ------------------------------------------------------------
...
-- Delete statements where Aberrê (Santo Amaro) is SUBJECT or OBJECT
DELETE FROM genealogy.statements
...
-- Delete the duplicate Aberrê profile
DELETE FROM genealogy.person_profiles
WHERE apelido = 'Aberrê' AND apelido_context = 'Santo Amaro';
...
-- Source: entities/persons/aberre.sql (CHANGED)
-- ============================================================
