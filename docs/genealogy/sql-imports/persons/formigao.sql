-- ============================================================
-- GENEALOGY PERSON IMPORT: Formigão
...
-- ============================================================
-- DEPENDENCIES: persons/adama.sql, persons/eleuterio-de-souza.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1870 with 'decade' precision):
-- Formigão was active in 1907 (train incident) as a valentão alongside Adama
-- and Eleutério de Souza. To be an established valentão by 1907, he would
-- likely have been 25-40 years old, placing his birth around 1867-1882.
-- Using 1870 as midpoint estimate, consistent with Adama's estimated birth year.
--
-- ============================================================
