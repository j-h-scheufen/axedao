-- ============================================================
-- GENEALOGY PERSON IMPORT: Eleutério de Souza
-- Generated: 2025-12-10
-- Primary Sources:
--   - Jornal Pequeno, November 9, 1938
--   - Israel Ozanam, "Capoeira e capoeiras entre a Guarda Negra e a Educação Física no Recife"
--     https://www.academia.edu/7186292/Capoeira_e_capoeiras_entre_a_Guarda_Negra_e_a_Educação_Física_no_Recife
-- ============================================================
-- DEPENDENCIES: persons/adama.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1860 with 'decade' precision):
-- Eleutério was described as having "made an era in Recife in his youth" and was
-- a founder of the "primitive stevedore work" in Pernambuco. The stevedores union
-- (SINDESTIVA/PE) was founded in 1891, founded by formerly enslaved workers.
-- If Eleutério was 25-35 when helping organize stevedore work around 1891,
-- his birth would be ~1856-1866. By 1907 (train incident), he would have been
-- a mature, established figure. By 1938 when Jornal Pequeno wrote about him
-- (likely an obituary or memorial), he would have been elderly or recently deceased.
...
-- Association with Adama (1907 train incident)
