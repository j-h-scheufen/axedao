-- ============================================================
-- GENEALOGY PERSON IMPORT: Creoni
...
-- If 25-40 years old when active in 1935, birth = ~1895-1910.
-- Using 1905 as midpoint estimate. Less information available
-- than other Matatu Preto contemporaries - may have been younger
-- or less prominent.
--
-- ============================================================
