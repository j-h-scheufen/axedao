-- ============================================================
-- GENEALOGY PERSON IMPORT: Prata Preta
-- Generated: 2025-12-09
-- Primary Sources:
--   - https://capoeirahistory.com/prata-preta-an-exiled-capoeira/
--   - https://riomemorias.com.br/memoria/prata-preta/
--   - https://wikifavelas.com.br/index.php/Prata_Preta
--   - https://atlas.fgv.br/verbetes/revolta-da-vacina
--   - https://aterraeredonda.com.br/prata-preta-o-lider-negro-na-revolta-da-vacina/
--   - https://pretosnovos.com.br/2021/07/24/revolta-da-vacina/
--   - https://www.redalyc.org/journal/3381/338130374006/html/ (academic source on Acre deportations)
-- ============================================================
-- DEPENDENCIES: none
-- ============================================================
--
-- BIRTH YEAR (1874, year precision):
-- Multiple sources confirm Prata Preta was "approximately 30 years old" (cerca de 30 anos)
-- during the 1904 Vaccine Revolt. Wikipedia PT and several sources explicitly state
-- birth year as 1874. This aligns with 30 years old in 1904.
--
-- DEATH YEAR (unknown):
-- After deportation to Acre on December 25, 1904, nothing is known of his fate.
-- Some sources suggest newspaper references in 1907 and 1909 indicate he may have
-- returned to Rio de Janeiro, but this is unconfirmed. Death date unknown.
--
-- ============================================================
...
-- NOTE: No documented teacher-student relationships found for Prata Preta.
-- He was contemporary with the malandro/capoeira generation that included
-- Sete Coroas (~1885-1923) and later Madame Satã (1900-1976), but no
-- direct connection is documented in the sources.

-- NOTE: Prata Preta's capoeira skills are documented, but his teachers
-- are unknown. He learned capoeira in Rio de Janeiro's port district,
-- likely from the generation of dockworkers who practiced despite
-- criminalization in 1890.
