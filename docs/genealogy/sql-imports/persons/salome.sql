-- ============================================================
-- GENEALOGY PERSON IMPORT: Salomé
-- Generated: 2025-12-09
-- Primary Source: Mestre Atenilo testimony in "Atenilo, o relâmpago da Capoeira Regional" (1988)
-- ============================================================
-- DEPENDENCIES: persons/doze-homens.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1905 with 'decade' precision):
-- Salomé was active as a capoeirista in the 1920s-1930s per Mestre Atenilo.
-- If she was in her prime (20s-30s) during this period, birth = ~1895-1910.
-- Using 1905 as midpoint.
--
-- NAME VARIANTS: Also referred to as "Maria Salomé" in some sources.
-- The existing person-reports/maria-salome.md used "Maria Salomé" as the primary
-- name, but original sources (Atenilo testimony) typically use just "Salomé."
-- Using "Salomé" as the primary apelido for consistency with sources.
--
-- NOTE: The original person report stated Salomé was a "student of Maria Doze
-- Homens" - this is INCORRECT based on the primary source (Atenilo testimony).
-- Salomé and Maria dos Anjos were students of the MALE capoeirista "Doze Homens,"
-- not the female "Maria Doze Homens." These are distinct people.
--
-- ============================================================
...
-- Salomé associated_with Maria dos Anjos (fellow student of Doze Homens)
-- NOTE: Maria dos Anjos not yet in dataset - relationship pending her import
-- INSERT INTO genealogy.statements (...)
-- WHERE s.apelido = 'Salomé' AND o.apelido = 'Maria dos Anjos'
