...
-- Primary Sources:
--   - https://fundacaomestrebimba.org.br/mestre-bimba/
...
-- - Was African-born (suggests pre-1850s-1870s birth for someone active in 1910s Brazil)
-- - Was a captain (established profession) and teaching capoeira by 1911
-- - If he was 35-45 when teaching 12-year-old Bimba in 1911, birth = ~1866-1876
...
-- No statements can be generated yet because Mestre Bimba is not in the dataset.
-- When Mestre Bimba is imported, the following relationship should be created:
--
-- Mestre Bimba student_of Bentinho
--   started_at: ~1911 (approximate)
--   ended_at: ~1915 (approximate)
--   confidence: verified
--   notes: Bentinho taught Bimba for approximately 4 years starting when Bimba was 12.
--          Training took place at Estrada das Boiadas / Clube União em Apuros in Liberdade, Salvador.
