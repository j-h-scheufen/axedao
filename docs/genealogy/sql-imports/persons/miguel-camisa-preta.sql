-- ============================================================
-- GENEALOGY PERSON IMPORT: Miguel Camisa Preta
-- Generated: 2025-12-11
-- Primary Sources:
--   - https://capoeirahistory.com/black-shirt/
--   - A Noite newspaper (July 12, 1912)
--   - A Gazeta de Notícias newspaper (July 12, 1912)
--   - Academic monograph: "Sambando na corda-bamba: capoeiras, fraudes eleitorais e malandragem"
-- ============================================================
-- DEPENDENCIES: persons/leao-do-norte.sql (for associated_with relationship)
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1878, decade precision):
-- Criminal life documented from 1902 until death in 1912. Known as the "príncipe
-- dos bambas" (prince of bambas), suggesting he was at peak of his career by the
-- late 1900s. Worked as cabo eleitoral (electoral agent) in 1909 elections. If he
-- was approximately 25-35 during his documented criminal period (1902-1912), birth
-- = ~1870-1887. Great friend of Leão do Norte (~1875) suggests similar age.
-- Using 1878 as compromise estimate.
--
-- DEATH: July 12, 1912 (exact date confirmed by A Noite and A Gazeta de Notícias)
-- Shot at dawn at Rua Núncio (now Av. Tomé de Souza / Visconde do Rio Branco)
--
-- ============================================================
...
-- NOTE: Potential relationships to document once those persons are imported:
-- - associated_with Prata Preta (contemporaries in Rio capoeira/malandro world, 1904 era)
-- - associated_with Sete Coroas (contemporaries in Rio underworld, ~1907-1912)
