-- ============================================================
-- GENEALOGY PERSON IMPORT: Barboza
...
-- Barboza was part of the Matatu Preto training group in Salvador in the 1930s.
-- By Canjiquinha's 1989 testimony, he was already deceased ("finado Barboza").
-- If he was 25-40 years old in the 1930s, he was born ~1890-1910. Using 1900.
--
-- DEATH: Unknown exact date, but deceased before Canjiquinha's 1989 testimony.
-- Given the "finado" reference in 1989, he likely died mid-20th century.
--
-- ============================================================
