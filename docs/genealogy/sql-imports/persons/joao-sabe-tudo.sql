-- ============================================================
-- GENEALOGY PERSON IMPORT: João Sabe Tudo
-- Generated: 2025-12-10
-- Primary Sources:
--   - Educando com Ginga (webnode page on Nascimento Grande)
--   - Grupo Capoeira Raça Negra (Nascimento Grande page)
--   - Various historical accounts of Recife capoeira and valentões
-- ============================================================
-- DEPENDENCIES: persons/nascimento-grande.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1850 with 'decade' precision):
-- João Sabe Tudo was a contemporary and rival of Nascimento Grande (1842-1936).
-- To be an effective rival and "one of the most feared fighters of Recife," he
-- would need to be in his physical prime during the late 19th century. If their
-- famous fights occurred during the 1880s-1900s (Nascimento's prime), João would
-- likely be born around 1840-1860. A birth year of c. 1850 makes him roughly 8
-- years younger than Nascimento, placing him at ages 30-50 during the prime
-- rivalry period.
--
-- ============================================================
...
-- Association with Nascimento Grande (fierce rival and paradoxical friend)
