-- ============================================================
-- GENEALOGY PERSON IMPORT: Besourinho
-- Generated: 2025-12-09
-- Primary Source: https://velhosmestres.com/br/destaques-34
-- ============================================================
-- DEPENDENCIES: onca-preta.sql (for relationship)
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1880, decade precision):
-- Onça Preta (born 1909) stated he "jumped" with Besourinho as "still
-- a boy." If Onça Preta was 6-15 years old (1915-1924) and Besourinho
-- was 25-45 when teaching, birth = ~1870-1899. Using 1880 as midpoint.
-- Besourinho was killed during Pedrito persecution (1920+), so he was
-- active as a teacher before then.
--
-- DEATH: Killed during Pedrito persecution (1920-1927). Using 1925 as
-- midpoint estimate with 'decade' precision. Manner: assassinated after
-- capture by police, body thrown in forest with knife wounds.
--
-- ============================================================
...
-- No other relationships documented for Besourinho.
-- He is only known through Onça Preta's testimony.
