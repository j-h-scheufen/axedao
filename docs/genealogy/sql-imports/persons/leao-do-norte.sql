-- ============================================================
-- GENEALOGY PERSON IMPORT: Leão do Norte
-- Generated: 2025-12-11
-- Primary Sources:
--   - https://capoeirahistory.com/black-shirt/
--   - A Noite newspaper (July 12, 1912) - reporting on context of Miguel Camisa Preta death
...
-- Leão do Norte was described as a "capoeira valente das ruas" (tough capoeira from
-- the streets) and "great friend" of Miguel Camisa Preta. He was killed by police
-- officer Elpídio Ribeiro da Rocha approximately one year before Miguel's death on
-- July 12, 1912 (so ~1911). If he was an established street capoeirista in ~1911,
-- likely 30-40 years old. Birth = ~1871-1881. Using 1875 as midpoint.
--
-- DEATH: ~1911 (year precision) - killed by Cabo Elpídio Ribeiro da Rocha
-- "A rixa entre o cabo Elpídio e Miguel começara um ano antes, quando Elpídio
-- matara outro malandro, um conhecido como Leão do Norte"
--
-- ============================================================
...
-- NOTE: The relationship to Miguel Camisa Preta is documented in miguel-camisa-preta.sql
-- (Miguel associated_with Leão do Norte as "great friends")

-- No other relationships documented for Leão do Norte.
