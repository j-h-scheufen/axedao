-- ============================================================
-- GENEALOGY PERSON IMPORT: Pinta Preta da Lapa
-- Generated: 2025-12-10
-- Primary Sources:
--   - Plácido de Abreu, "Os Capoeiras" (1886) - first book on capoeira
--   - Carlos Eugênio Líbano Soares, "A Negregada Instituição" (1999)
--   - https://capoeirahistory.com/classical-texts-of-capoeira-history-placido-de-abreu-1886/
--   - Newspaper accounts from January 1870
-- ============================================================
-- DEPENDENCIES: persons/manduca-da-praia.sql, persons/placido-de-abreu.sql
-- ============================================================
--
-- DEATH DATE: January 6-7, 1870 (exact night confirmed by multiple sources)
-- Killed on Rua da Alfândega, near the Travessa de S. Domingos, during the
-- Festa dos Reis (King's Day celebration).
--
-- BIRTH YEAR ESTIMATION (1840 with 'decade' precision):
-- Pinta Preta was described as chief of the Glória capoeiras and a member
-- of the National Guard at the time of his death in 1870. To be a gang chief
-- and National Guard member, he was likely 25-40 years old, placing his
-- birth in the 1830s-1840s range. Using 1840 as midpoint.
--
-- ============================================================
...
-- Manduca da Praia exists in the dataset. As contemporaries in the same
-- capoeira milieu of 1850s-1870s Rio de Janeiro.
...
--
-- - associated_with Jacó (victim in vendetta cycle after Pinta Preta)
-- - associated_with Alemãozinho (victim in vendetta cycle)
-- - associated_with Manduca Tambor / Manuel Maria Trindade (killer - NOT a capoeirista per se, Import? = no)
-- - associated_with Antonico Moleque (accomplice in killing - Import? = ?)
-- - associated_with Dr. Cereja / João Maria da Silva Seabra (falsely boasted of killing - Import? = ?)
-- ============================================================
