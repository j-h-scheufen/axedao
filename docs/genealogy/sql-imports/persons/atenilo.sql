-- ============================================================
-- GENEALOGY PERSON IMPORT: Atenilo
-- Generated: 2025-12-09
-- Primary Sources:
--   - https://www.recantodasletras.com.br/artigos-de-esporte/7729009
--   - https://www.recantodasletras.com.br/artigos-de-esporte/6737383
--   - https://testcapo.wordpress.com/tag/legend-of-besouro-manganga/
-- ============================================================
-- DEPENDENCIES: none (Mestre Bimba not yet imported)
-- ============================================================
--
-- BIRTH DATE: July 16, 1918 - verified from Atenilo's own testimony to Mestre Itapoan:
-- "I was born on July 16, 1918 in Oliveira, District of Santo Amaro da Purificação, Bahia"
--
-- DEATH DATE: 1986 - exact date unknown, year confirmed by multiple sources.
--
-- NICKNAME: "Relâmpago" (Lightning) was given ironically/humorously because his
-- playing style was actually slow ("tardo, lerdo, ingênuo"), not fast like lightning.
--
-- BROTHER CLAIM: Some sources claim Atenilo was brother to Neco Canário Pardo
-- and used the nickname "Cordão de Ouro." This is chronologically problematic:
-- Neco Canário Pardo (estimated birth c. 1880) and Atenilo (born 1918) have a
-- ~38-year age gap. They may have been half-brothers or the claim may be erroneous.
-- Mestre Waldemar attributed "Cordão de Ouro" to Besouro Mangangá himself.
--
-- ============================================================
...
-- Association with Neco Canário Pardo (alleged brother - DISPUTED)
...
-- ============================================================
-- 1. Atenilo student_of Mestre Bimba (1929-1974, 45 years) - requires Mestre Bimba import
-- 2. Mestre Pintor trained_under Atenilo - requires Mestre Pintor import (per taylorsbantus.wordpress.com)
