-- ============================================================
-- GENEALOGY PERSON IMPORT: Sinhozinho
-- Generated: 2025-12-09
-- Primary Sources:
--   - https://capoeirahistory.com/mestre/master-sinhozinho-1891-1962/
--   - https://en.wikipedia.org/wiki/Agenor_Moreira_Sampaio
--   - https://nossa-tribo.com/mestre-sinhozinho/
--   - https://www.lalaue.com/learn-capoeira/mestre-sinhozinho/
--   - Diário de Notícias newspaper, September 1, 1931
--   - A Noite newspaper, April 1, 1949
-- ============================================================
-- DEPENDENCIES: persons/cyriaco.sql, persons/zeca-floriano.sql
-- ============================================================
--
-- BIRTH YEAR (1891, year precision):
-- Multiple sources confirm he was born in 1891 in Santos, São Paulo.
-- His father was Lt. Col. José Moreira de Sampaio, briefly mayor of
-- Santos in 1899.
--
-- DEATH YEAR (1962, year precision):
-- Died in 1962 in Ipanema, Rio de Janeiro. Exact date not found in sources.
-- Honored with a statue in Ipanema and a street named after him in
-- Ilha do Governador.
--
-- ============================================================
...
--
-- Person-to-Person (teachers):
-- - Sinhozinho trained_under Edú Chaves (1904-?) - Greco-Roman wrestling, savate
--   Requires: persons/edu-chaves.sql (may not be capoeira-relevant)
--
-- Person-to-Person (students - may require separate mestre entries):
-- - Rudolf Hermanny student_of Sinhozinho
-- - Cirandinha student_of Sinhozinho
-- - André Jansen student_of Sinhozinho
-- - Tom Jobim student_of Sinhozinho (cultural interest only, not a capoeirista)
--
-- Person-to-Person (contemporaries/rivals):
-- - Sinhozinho associated_with Mestre Bimba (1949 challenge)
--   Requires: persons/bimba.sql
--
-- ============================================================
