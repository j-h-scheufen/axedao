-- ============================================================
-- GENEALOGY PERSON IMPORT: Aleixo Açougueiro
...
-- Aleixo Açougueiro is documented as a "perigoso capoeira" (dangerous capoeirista)
...
--
-- APELIDO MEANING: "Açougueiro" means "butcher" in Portuguese. This likely
-- indicates his profession. Portuguese butchers were documented as bringing
-- navalha (razor) fighting techniques to Brazil and integrating with the
-- capoeira maltas. Alternatively, the name could reference his fighting style.
--
-- ============================================================
...
SELECT
  ...
  '{"association_context": "Both were active capoeiristas in Rio de Janeiro around 1850. Aleixo Açougueiro is documented as one of the dangerous capoeiras of Manduca''s era in Plácido de Abreu''s Os Capoeiras (1886) and Melo Morais Filho''s Festas e Tradições (1888)."}'::jsonb,
...
SELECT
  ...
  '1850-01-01'::date, 'decade'::genealogy.date_precision,
  NULL, 'unknown'::genealogy.date_precision,
  '{"association_context": "Both named among the dangerous capoeiras of 1850s Rio de Janeiro in Plácido de Abreu''s Os Capoeiras (1886) and Melo Morais Filho''s Festas e Tradições (1888)."}'::jsonb,
  'likely'::genealogy.confidence,
  'Plácido de Abreu, "Os Capoeiras" (1886); Melo Morais Filho, "Festas e Tradições Populares do Brasil" (1888)',
