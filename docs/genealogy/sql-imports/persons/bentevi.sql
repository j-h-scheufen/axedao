-- ============================================================
-- GENEALOGY PERSON IMPORT: Bentevi
...
-- ============================================================
-- DEPENDENCIES: persons/manduca-da-praia.sql, persons/mamede.sql, persons/aleixo-acougueiro.sql, persons/pedro-cobra.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1820 with 'decade' precision):
-- Bentevi is documented as a "perigoso capoeira" (dangerous capoeirista)
...
--
-- APELIDO MEANING: "Bem-te-vi" or "Bentevi" is a Brazilian bird (Pitangus
-- sulphuratus), known for its distinctive yellow breast and aggressive
-- territorial behavior. The name literally means "I saw you well" from
-- its call. Animal nicknames were common among capoeiristas.
--
-- ============================================================
...
SELECT
  ...
  '{"association_context": "Both were active capoeiristas in Rio de Janeiro around 1850. Bentevi is documented as one of the dangerous capoeiras of Manduca''s era in Plácido de Abreu''s Os Capoeiras (1886) and Melo Morais Filho''s Festas e Tradições (1888)."}'::jsonb,
