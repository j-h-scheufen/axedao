-- ============================================================
-- GENEALOGY PERSON IMPORT: Mestre Bimba
-- Generated: 2025-12-09
-- Primary Sources:
--   - https://en.wikipedia.org/wiki/Manuel_dos_Reis_Machado
--   - https://www.lalaue.com/learn-capoeira/mestre-bimba/
--   - https://capoeira.online/history/mestres/mestre-bimba/
--   - https://papoeira.com/en/mestre-bimba-his-early-life-and-introduction-to-capoeira/
--   - https://papoeira.com/en/an-intro-to-mestre-bimba-part-2-the-foundation-of-capoeira-regional/
--   - https://capoeira-connection.com/capoeira/2011/10/who-was-mestre-bimba/
-- ============================================================
-- DEPENDENCIES: persons/bentinho.sql, persons/cobrinha-verde.sql
-- ============================================================
--
-- NOTE: Mestre Bimba is one of the most important figures in capoeira history.
-- This import includes relationships to entities that exist in our dataset.
-- Many students are listed in the persons-backlog for future import.
--
-- ============================================================
...
-- Mestre Bimba associated_with Besouro Mangangá (contemporary)
...
--
-- STUDENTS:
-- - Mestre Acordeon student_of Mestre Bimba
-- - Mestre Itapoan student_of Mestre Bimba
-- - Mestre Decânio student_of Mestre Bimba
-- - Mestre Nenel student_of Mestre Bimba (son)
-- - Mestre Vermelho 27 student_of Mestre Bimba
-- - Mestre Camisa Roxa student_of Mestre Bimba
-- - Mestre Ezequiel student_of Mestre Bimba
-- - Mestre Cafuné student_of Mestre Bimba
-- - Cisnando Lima student_of Mestre Bimba
-- - Jair Moura student_of Mestre Bimba
-- - Jurandir student_of Mestre Bimba
-- - Fernando Rodrigues Perez student_of Mestre Bimba
--
-- FAMILY:
-- - Mestre Bimba family_of Luiz Cândido Machado (father)
--   Note: Luiz is in backlog; relationship includes batuque training
-- - Mestre Bimba family_of Mestre Nenel (son)
--
-- TITLE GRANTS:
-- - Mestre Bimba granted_title_to Decânio (white handkerchief)
-- - Mestre Bimba granted_title_to Jair Moura (white handkerchief)
-- - Mestre Bimba granted_title_to Miranda (white handkerchief)
-- - Mestre Bimba granted_title_to Edinho (white handkerchief)
--
-- ASSOCIATIONS/RIVALRIES:
-- - Mestre Bimba associated_with Mestre Pastinha (contemporary)
