-- ============================================================
-- GENEALOGY PERSON IMPORT: Zeca Floriano
-- Generated: 2025-12-09
-- Primary Sources:
--   - https://capoeirahistory.com/mestre/master-sinhozinho-1891-1962/
--   - https://www.scielo.br/j/heduc/a/xThjX4DzwVwkbbqT65Y8DPc/
--   - https://www.tapology.com/fightcenter/fighters/267234-jose-floriano-peixoto-zeca
--   - https://saopauloantiga.com.br/o-leao-e-o-filho-do-presidente/
-- ============================================================
-- DEPENDENCIES: none
-- ============================================================
--
-- BIRTH YEAR (1887, year precision):
-- Academic sources (SciELO, Redalyc) give August 5, 1887. Some popular
-- sources give 1885. Using 1887 per academic research. Tapology gives 1885,
-- but academic papers citing historical records preferred.
--
-- DEATH YEAR (~1966-1972, decade precision):
-- Exact date unknown. Academic research indicates death occurred "between
-- August 1966 and November 1972" based on last known birthday greeting in
-- press and cessation of newspaper mentions. Using 1970 as midpoint estimate.
--
-- CAPOEIRA EVIDENCE:
-- capoeirahistory.com describes him as "excellent capoeirista" who taught
-- Sinhozinho pernada/capoeira carioca. His father Marshal Floriano Peixoto
-- was also documented as a capoeira practitioner. Academic papers on Zeca
-- focus on circus/athletics but don't mention capoeira directly.
--
-- ============================================================
...
-- NOTE: The trained_under relationship (Sinhozinho trained_under Zeca Floriano)
-- is defined in sinhozinho.sql, where the subject (Sinhozinho) is the owner of
-- the predicate.
