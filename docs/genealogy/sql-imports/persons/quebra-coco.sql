-- ============================================================
-- GENEALOGY PERSON IMPORT: Quebra Coco
...
-- ============================================================
-- DEPENDENCIES: persons/manduca-da-praia.sql, persons/mamede.sql, persons/aleixo-acougueiro.sql, persons/pedro-cobra.sql, persons/bentevi.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1820 with 'decade' precision):
-- Quebra Coco is documented as a "perigoso capoeira" (dangerous capoeirista)
...
--
-- APELIDO MEANING: "Quebra Coco" means "Coconut Breaker" in Portuguese.
-- "Coco" is Brazilian slang for head (like the coconut), and headbutts
-- (cabeçadas) were a primary fighting technique in 19th century capoeira
-- carioca. The name likely references powerful headbutt abilities.
--
-- ============================================================
