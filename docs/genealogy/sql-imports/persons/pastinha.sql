-- ============================================================
-- GENEALOGY PERSON IMPORT: Mestre Pastinha
-- Generated: 2025-12-09
-- Primary Source: https://en.wikipedia.org/wiki/Vicente_Ferreira_Pastinha
-- ============================================================
-- DEPENDENCIES: persons/benedito.sql, persons/aberre.sql, persons/cobrinha-verde.sql, persons/bimba.sql, persons/totonho-de-mare.sql, groups/ceca.sql, groups/gengibirra.sql
-- ============================================================
--
-- Mestre Pastinha (Vicente Ferreira Pastinha) - The "Father of Capoeira Angola"
-- Founder of Centro Esportivo de Capoeira Angola (CECA), the first Capoeira Angola
-- academy. His codification of the traditional style preserved African-rooted
-- capoeira practices against the modernizing reforms of Capoeira Regional.
--
-- ============================================================
...
-- Pastinha student_of Benedito (African teacher)
...
-- Aberrê trained_under Pastinha (c. 1910-1912)
-- NOTE: Disputed - some sources say Aberrê was Pastinha's teacher, others say student
...
-- Cobrinha Verde member_of CECA (member #28, admitted August 12, 1955)
-- Cobrinha Verde IS in dataset
INSERT INTO genealogy.statements (
  subject_type, subject_id,
  predicate,
  object_type, object_id,
...
-- Pastinha associated_with Mestre Bimba (contemporaries, complementary roles in Salvador capoeira)
-- Mestre Bimba IS in dataset
INSERT INTO genealogy.statements (
  subject_type, subject_id,
  predicate,
  object_type, object_id,
...
-- Pastinha associated_with Totonho de Maré (Gengibirra founder, CECA contemporary)
-- Totonho de Maré IS in dataset
INSERT INTO genealogy.statements (
  subject_type, subject_id,
  predicate,
  object_type, object_id,
...
--
-- TEACHER:
-- 1. Pastinha student_of Benedito (c. 1899-1902)
--    - confidence: verified
--    - properties: { training_location: "Rua das Laranjeiras, n° 26, Pelourinho, Salvador" }
--    - source: "velhosmestres.com/br/pastinha-1899; Pastinha's own interviews"
--
-- STUDENTS (all need student_of relationships TO Pastinha):
-- 2. João Grande student_of Pastinha (~1945-1981)
--    - confidence: verified
--    - source: Multiple sources; Pastinha's own words
--    - note: Principal disciple, entrusted with legacy
--
-- 3. João Pequeno student_of Pastinha (~1945-1981)
--    - confidence: verified
--    - source: Multiple sources; Pastinha's own words
--    - note: Principal disciple, designated to continue CECA
--
-- 4. Curió student_of Pastinha
--    - confidence: verified
--    - source: ceca-riovermelho.org.br; nossa-tribo.com
--
-- 5. Albertino student_of Pastinha
--    - confidence: verified
--    - source: ceca-riovermelho.org.br
--
-- 6. Gildo Alfinete student_of Pastinha
--    - confidence: verified
--    - source: Multiple sources; went to Dakar 1966
--
-- 7. Valdomiro student_of Pastinha
--    - confidence: verified
--    - source: ceca-riovermelho.org.br
--
-- 8. Boca Rica student_of Pastinha
--    - confidence: verified
--    - source: lalaue.com; nossa-tribo.com
--
-- 9. Bola Sete student_of Pastinha
--    - confidence: verified
--    - source: Multiple sources
--
-- 10. Gato Preto student_of Pastinha
--    - confidence: likely
--    - source: lalaue.com; velhosmestres.com
--    - note: Also worked with Cobrinha Verde
--
-- 11. Roberto Satanás student_of Pastinha
--    - confidence: verified
--    - source: Went to Dakar 1966
--
-- 12. Camafeu de Oxossi student_of Pastinha
--    - confidence: verified
--    - source: Went to Dakar 1966; played berimbau
--
-- GROUPS:
-- 13. Pastinha founded CECA (February 23, 1941)
--    - confidence: verified
--    - properties: { official_registration: "October 1, 1952" }
--
-- 14. Pastinha leads CECA (1941-1971)
--    - confidence: verified
--    - ended_at: 1971 (eviction from Pelourinho building)
--
-- 15. Pastinha leads Gengibirra (from 1941)
--    - confidence: verified
--    - source: "Amorzinho handed leadership to Pastinha"
--
-- LEGENDARY CAPOEIRISTAS (contemporaries mentioned by Pastinha):
-- From Pastinha's 1967 interview listing "pure capoeira de Angola" practitioners:
-- Bigode de Seda, Américo Ciência, Bugalho, Amorzinho, Zé Bom Pé, Chico Três Pedaços,
-- Tibirici da Folha Grossa, Doze Homens, Inimigo Sem Tripa, Zé do U, Vitorino Braço Torto,
-- Zé do Saco, Bené do Correio, Sete Mortes, Chico Me Dá, Júlia Fogareira, Maria Homem
-- ============================================================
