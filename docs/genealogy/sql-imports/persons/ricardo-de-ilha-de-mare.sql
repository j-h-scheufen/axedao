-- ============================================================
-- GENEALOGY PERSON IMPORT: Ricardo de Ilha de Maré
-- Generated: 2025-12-10
-- Primary Sources:
--   - http://velhosmestres.com/en/waldemar-1989-2 (1989 interview)
...
--   - https://grupoliberdadecapoeira.com.br/linhagem-mestres/
-- ============================================================
-- DEPENDENCIES: persons/totonho-de-mare.sql
-- ============================================================
--
-- BIRTH YEAR ESTIMATION (1890, decade precision):
-- Ricardo de Ilha de Maré was teaching Mestre Waldemar starting in 1936, when
-- Waldemar was 20 years old. As an established mestre from the same island where
-- Waldemar was born (1916), Ricardo was likely an older practitioner who had been
-- teaching on Ilha de Maré for many years. To be recognized as a mestre teaching
-- adults in 1936, he would likely have been in his 40s-50s at minimum. This places
-- his birth around 1880-1900. Using 1890 as midpoint estimate.
--
-- DEATH: Unknown. No records found. Last documented activity: teaching Mestre
-- Waldemar starting around 1936.
--
-- ============================================================
...
-- When Waldemar is imported, add:
-- Waldemar trained_under Ricardo de Ilha de Maré (~1936-1940)

-- Ricardo de Ilha de Maré associated_with Totonho de Maré (both from Ilha de Maré)
-- This is a likely association given they were both from the same small island
-- and active in overlapping time periods (Totonho 1894-1974, Ricardo active ~1920s-1940s)
