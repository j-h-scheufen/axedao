-- ============================================================
-- GENEALOGY PERSON IMPORT: Alemãozinho
...
-- ============================================================
-- DEPENDENCIES: persons/jaco.sql, persons/pinta-preta-da-lapa.sql, persons/placido-de-abreu.sql
-- ============================================================
--
-- DEATH DATE: ~1870 (exact date unknown, after Jacó's death)
-- Killed near the old Teatro Lírico do Campo by the famous César-Maneta.
--
-- BIRTH YEAR ESTIMATION (1840 with 'decade' precision):
-- Alemãozinho was killed in the vendetta cycle following Jacó's death (1870).
...
-- Consecutive victims in the vendetta cycle
...
--
-- - associated_with César-Maneta (killer - Import? = yes)
-- - associated_with João-Lagalhé (killed César-Maneta, continuing cycle - Import? = yes)
-- ============================================================
