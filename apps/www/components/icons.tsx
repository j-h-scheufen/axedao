...
export const DiscordIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg aria-labelledby="discordTitle" height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
...
export const TwitterIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg aria-labelledby="twitterTitle" height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
...
export const GithubIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg aria-labelledby="githubTitle" height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
...
export const MoonFilledIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    ...
    {...props}
  >
    <title id="moonTitle">Dark theme</title>
    <path
...
export const SunFilledIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    ...
    {...props}
  >
    <title id="sunTitle">Light theme</title>
    <g fill="currentColor">
