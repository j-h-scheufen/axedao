...
const Logo: React.FC<IconSvgProps> = ({ size = 36, width, height, ...props }) => (
  <svg fill="none" height={size || height} viewBox="0 0 32 32" width={size || width} {...props} aria-labelledby="logo">
...
const DiscordIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props} aria-labelledby="discord">
      <title id="discord">Discord</title>
      <path
...
const TwitterIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props} aria-labelledby="twitter">
...
const GithubIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props} aria-labelledby="github">
...
const NextUILogo: React.FC<IconSvgProps> = (props) => {
  ...
  return (
    <svg
      ...
      aria-labelledby="nextui-logo"
      {...props}
    >
      <title id="nextui-logo">NextUI Logo</title>
      <path
